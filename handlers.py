...
def btns_chep():
    ...
    btn_chep_1 = types.InlineKeyboardButton(
        "Первый чепух!", url="https://vk.com/elkinay"
    )
    btn_chep_2 = types.InlineKeyboardButton(
        "Второй чепух!", url="https://vk.com/zimeervir"
    )
    btn_chep_3 = types.InlineKeyboardButton(
        "Третий чепух!", url="https://vk.com/id299453853"
    )
